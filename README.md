...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/pywatershed-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/pywatershed-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add pywatershed
# for installing globally
pixi global install pywatershed
```
...
It is possible to list all of the versions of `pywatershed` available on your platform:
...
```
pixi search pywatershed --channel conda-forge
```
